...
const manualesPosicion = [
  ...
  { titulo: "La Mente del Lateral Izquierdo", deporte: "Fútbol", desc: "Equilibrio defensivo-ofensivo, duelos individuales y proyección al ataque.", precio: "$19.99", disponible: false },
...
export default function ManualesPosicion() {
  ...
  const filtrados = manualesPosicion.filter(
    (m) => deporteActivo === "Todos" || m.deporte === deporteActivo
  );
