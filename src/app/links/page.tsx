...
function IconGift() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6" stroke="#0a0a0a" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
const links = [
  {
    href: "https://lazonacampeon.com/gratis",
    label: "Guía gratis — Los 5 Hábitos Mentales",
    sub: "PDF descargable al instante",
    gold: true,
    icon: <IconGift />,
    iconBg: null,
  },
