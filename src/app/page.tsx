...
const productos = [
  {
    ...
    titulo: "Guía: 5 Hábitos Mentales del Campeón",
    desc: "Tu primer paso. 5 hábitos mentales que los atletas de élite practican cada día. PDF descargable al instante.",
    precio: "GRATIS",
  ...
  },
  {
    ...
    titulo: "Manuales por Posición",
    desc: "Guías específicas por posición deportiva (fútbol, básquetbol, tenis y más). Cada manual aborda los retos mentales únicos de tu puesto.",
    precio: "Desde $9.99",
    cta: "Ver Manuales",
    href: "/productos",
    highlight: false,
  },
  {
    ...
    titulo: "Libro Completo + Packs",
    desc: '"La Mente del Campeón" en PDF completo (10 capítulos + epílogo). También disponible en packs por deporte con todos los manuales de posición.',
    precio: "Desde $27",
    cta: "Ver Productos",
    href: "/productos",
    highlight: true,
  },
  {
    ...
    titulo: "Programas y Kits",
    desc: "Programa de 21 días de entrenamiento mental, Kit del Entrenador con licencia de uso, y packs avanzados para academias.",
    precio: "Desde $97",
    cta: "Ver Programas",
    href: "/productos",
    highlight: false,
